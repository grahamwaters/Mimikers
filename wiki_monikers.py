...
year_categories = ['{}s_in_Internet_culture'.format(str(year)) for year in range(1970,2020,10)]
        ...
        try:
            ...
            if random.randint(0, 1) == 0 or not activate_loop:
                try:
                    ...
                    URL = generate_related_deck(page_title,10)[0] # get the first related page
